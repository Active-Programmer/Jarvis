...
# ALL THE MODULES AND LIBRARIES IMPORTED FOR THE PROJECT
...
# ALSO JARVIS WILL READ THE LINES FROM WIKIPEDIA 
...
# THIS IS THE MAIN FUNCTION FROM WHERE THE EXECUTION OF THE CODE WILL START
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # THESE ARE SOME IF AND ELIF STATEMENTS

        if 'wake up' in input:
            speak("I m already waked up, shaan!, What about you!")

        elif "i am here" in input:
            speak("Ok Sir!! Glad to hear you!!")
            ...
            speak("I can perform many functions Sir!! Like I can open any application for you Sir!! And also I can search for anything!!")
            ...
            speak("So!! My boss Shanu, calls me jarvis.. i am a Virtual Assisstant of my boss Mr. Shaanu!!")
            speak("And I am here to make my boss life easier!!")
        
        elif 'rakshit tandon' in input:
            speak("Hello Mr. Tandon! How are you! You are doing a great job!! My boss admires you")

        elif 'who are you' in input:
            speak("i m mr. shaan's assisstant!! and I m here to make my boss life easier")
        
        elif "who created you" in input:
            speak("I am created by Mr. Shaan for a his prject of Cyber Security Summer Intership Gurugram 2020!!")
        
        elif "how are you" in input:
            speak("I m fine Shaan, Glad to hear you! What about you!")

        elif "i am fine" in input:
            speak("Ok that's great, please command me to do something for you!!")

        elif "i love you" in input:
            speak("I love you too Shaan!! But dont understand what is love!! please explain me!!")

        elif "leave it"in input:
            speak("Ok sir!!")

        elif "thank you" in input:
            speak("No Problem Sir!! Enjoy!!")
